...
ColumnLayout{
    ...
    PackagesInstallTab{
        ...
        model: [{
                ...
                showAgain: true,
                imagesURLList: [
                    "qrc:/slides/vscodeguide/open.png",
                    "qrc:/slides/vscodeguide/toolkit.png",
                    "qrc:/slides/vscodeguide/toolkit2.png",
                    "qrc:/slides/vscodeguide/lists.png",
                    "qrc:/slides/vscodeguide/terminal.png",
                    "qrc:/slides/vscodeguide/build.png",
                    "qrc:/slides/vscodeguide/output.png",
                    "qrc:/slides/vscodeguide/flash.png",
                    "qrc:/slides/vscodeguide/flash_output.png",
//                    "qrc:/slides/vscodeguide/debug.png",
//                    "qrc:/slides/vscodeguide/registers.png",
//                    "qrc:/slides/vscodeguide/registers_edit.png",
//                    "qrc:/slides/vscodeguide/registers_rmb.png",
//                    "qrc:/slides/vscodeguide/registers_binary.png",
//                    "qrc:/slides/vscodeguide/registers_bit.png",
                ],
                hintList: [
                    "Запустите VS Code. Во вкладке \"Файл\" выберите \"Открыть папку...\", выберите папку с проектом.",
                    "Откройте список комплектов.",
                    "Выберите комплект \"Unspecified\".",
                    "Сохраните файл \"CMakeLists.txt\" для конфигурации проекта.",
                    "Во вкладке \"Терминал\" выберите \"Запуск задачи\".",
                    "Для сборки проекта нажмите \"Выпуск: собрать\" или CTRL+SHIFT+B.",
                    "В папку \"build\" помещается скомпилированная прошивка. В терминале указывается размер сегментов прошивки.",
                    "Для прошивки контроллера запустите задачу \"Загрузить в флеш-память\".",
                    "Пример вывода ионформации о процессе прошивки.",
