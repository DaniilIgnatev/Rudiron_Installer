...
//
// value [in]    wstring to match against and cut from the variable.
//
// Return Value: Returns the number of matching instances within the variable's
//               value that were cut.
unsigned int envCut (env_scope  scope,
                                 wchar_t const         *name,
                                 wchar_t const         *value);
...
//
// Return Value: Returns a const wstring containing the variable's value.
...
//
// Return Value: Nothing.
void pathAdd (env_scope, wchar_t const *path);
...
unsigned int pathRemove (env_scope, wchar_t const *path);
