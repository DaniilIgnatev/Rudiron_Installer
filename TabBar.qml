...
ColumnLayout{
    ...
    Tab{
        ...
        model: [{
                ...
                hintList: [
                    "На кладке \"Проекты\" можно изменить каталог сборки",
                    "На вкладке \"Начало\" выберете \"Настроить\" сессию",
                    "Нажмите \"Новая\"",
                    "Введите название и нажмите \"Создать\"",
                    "Выберите созданную сессию и нажмите \"Активировать\"",
                    "Нажмите \"Открыть файл или проект\"",
                    "Откройте .qbs файл проекта",
                    "Раскройте дерево проектов до \"app.cpp\"",
                    "Окно запуска программы",
                    "Окно предупреждений и ошибок",
                    "Окно поиска в проекте",
                    "Окно стандартного потока вывода",
                    "Информация о ходе сборки программы",
                    "Стек вызовов функций",
                    "Точки останова",
                    "Слева от порядкового номера строки выставляются точки останова",
                    "Окно локальных переменных",
                    "Окно регистров",
                    "В окне регистров переферии нажмите ПКМ",
                    "Список регистров выбранной переферии",
                    "Нажмите ПКМ для выбора формата отображения значений",
                    "Наведите на регистр для подробного вывода значения",
                    "Нажмите ПКМ для точного выставления точки останова",
                    "Продолжение отладки программы",
                    "Завершение отладки программы",
                    "Переключение отладчика в режим дизассемблера",
                    "Для настройки QtCreator перейдите в \"Инструменты->Параметры\"",
                    "Настройки текстового редактора",
                    "Рекомендуется шрифт DejaVu Sans Mono"],
